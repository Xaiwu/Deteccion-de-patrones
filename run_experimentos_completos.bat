...
for %%d in (%DATASETS%) do (
    echo algoritmo;patrones;tiempo_total;coincidencias;numdocs;espacio_bytes > output\%%d_patrones_variables.csv
    echo algoritmo;patrones;tiempo_total;coincidencias;numdocs;espacio_bytes > output\%%d_documentos_variables.csv
)
